                ...
                <div class="flex justify-content-center">
                    <div class="pt-5 pt-lg-0 order-2 order-lg-1 align-items-center">
                        <div data-aos="zoom-out">
                            <h1 class="text-center text-lg-center">Welcome Back to E<span
                                        ...
                                        <form method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="email" name="email" class="form-control" id="email"
                                                        <?php echo isset($_GET['email']) ? 'value=" ' . $_GET['email'] . '"' : 'placeholder="Juan@gmail.com"' ?>
                                            ...
                                            <div class="form-group d-md-flex mt-3">
                                                ...
                                                <div class="w-50 text-md-left">
                                                    <a href="#forgot_pass" class="register_links" role="button"
                                                        data-bs-toggle="modal">
                                                        Forgot password ?
                                                    </a>
                                                </div>
                                                <div class="w-50 text-md-right">
                                                    <a href="register.php" class="register_links">Don't have an account
                                                        ?</a>
                                                </div>
                                            </div>
