                                ...
                                ?>
                                    ...
                                    <section id="enroll_rna" class="enroll_rna">
                                        <div class="container">
                                            <div class="section-title" data-aos="fade-up">
                                                <h2 class="text-secondary">Enrollment</h2>
                                                <p style="color: #00008b;">Robotics and Automation Intermediate Level 2</p>
                                            </div>
                                            <?php
                                                // post gcash and security bank buttons in form 
                                                if(isset($_POST['submit_gcash']))
                                                                ...
                                                                <div class="col-md-5 d-md-block d-none p-0 box">
                                                                    <div class="card rounded-0 border-0 card1" id="bill">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-7 col-8 mt-4 line pl-4">
                                                                                <h2 class="head">Robotics and Automation</h2>
                                                                                <div class="data">Intermediate Level</div>
                                                                            </div>
                                                                            <div class="col-lg-5 col-4 mt-4">
                                                                                <img src="assets/img/certificates/rna/level 2.webp" width="200"
                                                                                    height="200">
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                ...
                                ?>
                                    ...
                                    <section id="enroll_rna" class="enroll_rna">
                                        <div class="container">
                                            <div class="section-title" data-aos="fade-up">
                                                <h2 class="text-secondary">Enrollment</h2>
                                                <p style="color: #00008b;">Robotics and Automation Advance Level 3</p>
                                            </div>
                                            <?php
                                                // post gcash and security bank buttons in form 
                                                if(isset($_POST['submit_gcash']))
                                                                ...
                                                                <div class="col-md-5 d-md-block d-none p-0 box">
                                                                    <div class="card rounded-0 border-0 card1" id="bill">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-7 col-8 mt-4 line pl-4">
                                                                                <h2 class="head">Robotics and Automation</h2>
                                                                                <div class="data">Advance Level</div>
                                                                            </div>
                                                                            <div class="col-lg-5 col-4 mt-4">
                                                                                <img src="assets/img/certificates/rna/level 2.webp" width="200"
                                                                                    height="200">
