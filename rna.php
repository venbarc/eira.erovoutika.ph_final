                                ...
                                <div class="container">
                                    ...
                                    <div class="container">
                                        <div class="card p-4" data-aos="fade-up">
                                            <div class="image d-flex flex-column justify-content-center align-items-center"> 
                                                <!-- img here  -->
                                                <img src="assets/img/certificates/rna/level 2.webp" height="200" width="200" />
                                                <!-- title here  -->
                                                <span class="name">INTERMEDIATE LEVEL</span> 
                                                <span class="idd"> ROBOTICS AND AUTOMATION</span>
                        ...
                        ?>
                            ...
                            <section id="certificate" class="certificate">
                                <div class="container">
                                    ...
                                    <div class="section-title" data-aos="fade-up">
                                        <h2 class="text-secondary">Certifications</h2>
                                        <p style="color: #00008b;">Robtics and automation Certifications</p>
                                    </div>
                                    ...
                                    <div class="container">
                                        <div class="card p-4" data-aos="fade-up">
                                            <div class="image d-flex flex-column justify-content-center align-items-center"> 
                                                <!-- img here  -->
                                                <img src="assets/img/certificates/rna/level 3.webp" height="200" width="200" />
                                                <!-- title here  -->
                                                <span class="name">ADVANCE LEVEL</span> 
                                                <span class="idd"> ROBOTICS AND AUTOMATION</span>
