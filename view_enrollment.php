            ...
            <?php
                if(isset($_GET['type']) && isset($_GET['approval']))
                {
                    ...
                    if($approval == $approval_db) // if approval url is actually equals to approval in db 
                    {
                        ...
                        if($type == 'wdv1' && $approval == 0)// START WDV 1 section PENDING APPROVAL
                        {
                            ?>
                                <!-- ======= start Hero ======= -->
                                <section id="hero">
                        ...
                        if($type == 'wdv1' && $approval == 1)// START WDV 1 section ACCEPTED APPROVAL
                        {
                            ?>
                                <!-- ======= start Hero ======= -->
                                <section id="hero">
                        ...
                        if($type == 'wdv1' && $approval == 2)// START WDV 1 section REJECTED APPROVAL
                        {
                            ?>
                                <!-- ======= start Hero ======= -->
                                <section id="hero">
