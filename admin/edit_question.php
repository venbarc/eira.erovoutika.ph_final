    ...
    <div class="p-4 sm:ml-64">
        <div class=" rounded-lg dark:border-gray-700">
            <section class="bg-white dark:bg-gray-900">
                ...
                <?php
                    if(isset($_GET['id']) && isset($_GET['rna_type']))
                    {
                        $id = $_GET['id'];
                        ...
                        if(isset($_POST['edit_question']))
                        {
                            ...
                            if($error == false) // if there are no errors proceed to update
                            {
                                ...
                                if($stmt->affected_rows > 0)
                                {
                                    ?>
                                        <script>
                                            location.href = "test_question.php?rna_type=<?php echo $rna_type?>";
                                        </script>
                                    <?php
                                }
                                else{
                                ...
                                ?>
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                            ...
                                            <div>
                                            <a href="test_question.php?rna_type=<?php echo $rna_type ?>" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
                                                Cancel
                                            </a>
                                            </div>
                                        </div>
