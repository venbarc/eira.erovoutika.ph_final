        ...
        <div class=" rounded-lg dark:border-gray-700">
            <section class="bg-white dark:bg-gray-900">
                    ...
                    <section class="bg-white dark:bg-gray-900">
                        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 ">
                            ...
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=wdv1" class="mr-2 text-5xl font-extrabold">
                                        WDV 1
                                    </a>
                                </div>
                            </div>
                            ...
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=wdv2" class="mr-2 text-5xl font-extrabold">
                                        WDV 2
                                    </a>
                                </div>
                            </div>
                            ...
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=wdv3" class="mr-2 text-5xl font-extrabold">
                                        WDV 3
                                    </a>
                                </div>
                            </div>
                            ...
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=wdv4" class="mr-2 text-5xl font-extrabold">
                                        WDV 4
                                    </a>
                                </div>
                            </div>
                             ...
                             <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=wdv5" class="mr-2 text-5xl font-extrabold">
                                        WDV 5
                                    </a>
                                </div>
                            </div>
                                        ...
                                        if(isset($_POST['submit_wdv1']))
                                        {
                                            ...
                                            if($error == false) // if there are no errors proceed to insert
                                            {
                                                ...
                                                if($stmt->affected_rows > 0)
                                                {
                                                    ?>
                                                        <div class="scs">
                                                            Successfully Added Question to Web dev 1.
                                                        </div>
                                                    <?php
                                                }else{
                                                    ?>
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Test
                            Create for Electronics & PCB Designing Exam</h2>
                    </div>
                    <section class="bg-white dark:bg-gray-900">
                        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 ">
                            <!-- EPCB dev 1 -->
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=epcb1" class="mr-2 text-5xl font-extrabold">
                                        EPCB 1
                                    </a>
                                </div>
                            </div>
                            ...
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=epcb2" class="mr-2 text-5xl font-extrabold">
                                        EPCB 2
                                    </a>
                                </div>
                            </div>
                            ...
                            <div
                                class="shadow-2xl flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                <div class="flex justify-center items-baseline my-8">
                                    <a href="test_create.php?type=epcb3" class="mr-2 text-5xl font-extrabold">
                                        EPCB 3
                                    </a>
                                </div>
                            </div>
                ...
                <?php
                    if(isset($_GET['type']))
                    {
                        ...
                        {
                            ?>
                                <!-- // epcb1 form is submitted  -->
                                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                    <?php
                                        if(isset($_POST['submit_epcb1']))
                                        {
                                            // variable initialization 
                                            $question = $_POST['question'];
                                            $opt1 = $_POST['opt1'];
                                            ...
                                            if($error == false) // if there are no errors proceed to insert
                                            {
                                                ...
                                                if($stmt->affected_rows > 0)
                                                {
                                                    ?>
                                                        <div class="scs">
                                                            Successfully Added Question to Electronics and PCB Design 1.
                                                        </div>
                                                    <?php
                                                }else{
                                                    ?>
                                ...
                                <!-- form for creating questions epcb1  -->
                                <form method="post" enctype="multipart/form-data">
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        
                                        <h3 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">EPCB 1 Question</h3>
                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                            <div>
                                                <!-- questions  -->
                                                <label for="ques" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question</label>
                                                ...
                                                <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                                    <div class="flex flex-col space-y-2">
                                                        ...
                                                        <label class="inline-flex items-center">
                                                            <input type="radio" class="form-radio text-blue-600" name="ques_type" value="ece" checked>
                                                            <span class="ml-2 text-gray-900 dark:text-white">Electronics Components and Equipment</span>
                                                        </label>
                                                        <label class="inline-flex items-center">
                                                            <input type="radio" class="form-radio text-blue-600" name="ques_type" value="ed">
                                                            <span class="ml-2 text-gray-900 dark:text-white">Electronics Design</span>
                                                        </label>
                                                        <label class="inline-flex items-center">
                                                            <input type="radio" class="form-radio text-blue-600" name="ques_type" value="pcpd">
                                                            <span class="ml-2 text-gray-900 dark:text-white">PCB Design</span>
                                                        </label>
                                                        <label class="inline-flex items-center">
                                                            <input type="radio" class="form-radio text-blue-600" name="ques_type" value="tnt">
                                        ...
                                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                            <div>
                                                <input type="submit" name="submit_epcb1" value="Add question epcb 1" class="inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            ?>
                                        ...
                                        if(isset($_POST['submit_epcb2']))
                                        {
                                            ...
                                            if($error == false) // if there are no errors proceed to insert
                                            {
                                                ...
                                                if($stmt->affected_rows > 0)
                                                {
                                                    ?>
                                                        <div class="scs">
                                                            Successfully Added Question to Electronics and PCB Design 2.
                                                        </div>
                                                    <?php
                                                }else{
                                                    ?>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <h3 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">EPCB 2 Question</h3>
                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                            <div>
                                                <!-- questions  -->
                                                <label for="ques" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question</label>
                                        ...
                                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                            <div>
                                                <input type="submit" name="submit_epcb2" value="Add question epcb 2" class="inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                            </div>
                                        </div>
                                    </div>
                                </form>
                            ...
                            ?>
                                        ...
                                        if(isset($_POST['submit_epcb3']))
                                        {
                                            ...
                                            if($error == false) // if there are no errors proceed to insert
                                            {
                                                ...
                                                if($stmt->affected_rows > 0)
                                                {
                                                    ?>
                                                        <div class="scs">
                                                            Successfully Added Question to Electronics and PCB Design 3.
                                                        </div>
                                                    <?php
                                                }else{
                                                    ?>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <h3 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">EPCB 3 Question</h3>
                                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                            <div>
                                                <!-- questions  -->
                                                <label for="ques" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Question</label>
                                        ...
                                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                            <div>
                                                <input type="submit" name="submit_epcb3" value="Add question epcb 3" class="inline-flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                            </div>
                                        </div>
                                    </div>
                                </form>
