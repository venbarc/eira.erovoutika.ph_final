    ...
    <div class="p-4 sm:ml-64">
        <div class=" rounded-lg dark:border-gray-700">
            <section class="bg-white dark:bg-gray-900">
                ...
                <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Questions for Electronics and PCB Design Exam</h2>
                </div>
                    <section class="bg-white dark:bg-gray-900">
                            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                                <!-- WDV 1 -->
                                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                    <div class="flex justify-center items-baseline my-8">
                                        <a href="test_question.php?type=epcb1" class="mr-2 text-5xl font-extrabold">EPCB 1</a>
                                    </div>
                                </div>
                                <!-- WDV 2 -->
                                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                    <div class="flex justify-center items-baseline my-8">
                                        <a href="test_question.php?type=epcb2" class="mr-2 text-5xl font-extrabold">EPCB 2</a>
                                    </div>
                                </div>
                                <!-- WDV 3 -->
                                <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                                    <div class="flex justify-center items-baseline my-8">
                                        <a href="test_question.php?type=epcb3" class="mr-2 text-5xl font-extrabold">EPCB 3</a>
                                    </div>
                                </div>
                            </div>
                    </section>
                    ...
                    if(isset($_GET['type']))
                    {
                        ...
                        if($type == 'epcb1')
                        {
                            ...
                            else
                            {
                                ...
                                <h2 class="text-gray-900 dark:text-white text-center" style="background: rgb(0,0,0,0.3); padding: 20px; font-size: 30px;">
                                    EPCB 1 Questions no records yet
                                </h2>
                                <?php
                            }
                        }
                        ...
                        if($type == 'epcb2')
                        {
                            ...
                            else
                            {
                                ?>
                                <h2 class="text-gray-900 dark:text-white text-center" style="background: rgb(0,0,0,0.3); padding: 20px; font-size: 30px;">
                                    EPCB 2 Questions no records yet
                                </h2>
                                <?php
                            }
                        }
                        ...
                        if($type == 'epcb3')
                        {
                            ...
                            else
                            {
                                ?>
                                <h2 class="text-gray-900 dark:text-white text-center" style="background: rgb(0,0,0,0.3); padding: 20px; font-size: 30px;">
                                    EPCB 3 Questions no records yet
                                </h2>
                                <?php
                            }
                        }
